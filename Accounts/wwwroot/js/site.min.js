/* $(function() {
  ...
  function newAnimationObj() {var timeline = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : new TimelineMax();
    var obj = {};
    obj.last = false;
    obj.start = function () {
      obj.last = false;
    ...
    obj.stop = function () {obj.last = true;};
    return obj;
  }
  ...
  $(document).on("mousedown touchstart", ".card", function (e) {
  ...
  $(document).on("mouseleave touchend", ".card", function (e) {
    e.preventDefault();
    [waveAnimation, treeAnimation, oilAnimation].forEach(function (obj) {obj.stop();});
});
